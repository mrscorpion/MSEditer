...
@implementation MSStyleFormatCell
{
...
- (void)selectButton:(UIButton *)button {
    ...
    MSTextStyleType type = [self.buttons indexOfObject:button];
    NSDictionary *settings = @{MSStyleSettingsFormatName : @(type)};
