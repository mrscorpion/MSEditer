...
@interface MSStyleColorCell () <MSColorPickerViewDataSource, MSColorPickerViewDelegate>

@property (weak, nonatomic) IBOutlet UIView *colorDisplayView;
@property (weak, nonatomic) IBOutlet MSColorPickerView *colorPickerView;

@end

@implementation MSStyleColorCell
{
...
#pragma mark - <MSColorPickerViewDataSource, MSColorPickerViewDelegate>
...
- (void)MS_colorPickerView:(MSColorPickerView *)pickerView didSelectColor:(UIColor *)color {
    ...
    [self.delegate MS_didChangeStyleSettings:@{MSStyleSettingsTextColorName: color}];
}
